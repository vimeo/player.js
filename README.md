...
* [Methods](#methods)
    ...
    + [setAutopause](#setautopause-boolean-promiseboolean-error)
    + [getColor](#getcolor-promisestring-error)
    + [setColor](#setcolor-string-promisestring-constrasterrortypeerrorerror)
    ...
    + [setVolume](#setvolume-number-promisenumber-rangeerrorerror)
- [Events](#events)
    + [play](#play)
    + [pause](#pause)
    + [ended](#ended)
